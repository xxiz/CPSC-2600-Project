...
function Deals() {
    ...
    const fetchDeals = async () => {
        const response = await fetch("https://projects.ashwin.lol/sales-scout-backend/api/v1/deals/trending");
    ...
    const getLastScraped = async (): Promise<string> => {
        const response = await fetch("https://projects.ashwin.lol/sales-scout-backend/api/v1/scrapes/latest");
